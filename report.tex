...
\subsubsection{Convolution Layer (Conv)}
\begin{itemize}
...
\caption{Ví dụ về kiến trúc CNN}
\end{center}
\end{figure}
...
\small{
$\textbf{INPUT} \rightarrow \textbf{CONV} \rightarrow \textbf{RELU} \rightarrow \textbf{DropOut} \rightarrow \textbf{CONV} \rightarrow \textbf{RELU} \rightarrow \textbf{POOL} 
\rightarrow \textbf{Fully-connect(RELU)} \rightarrow \textbf{DropOut} \rightarrow \textbf{Fully-connect(softmax)}$
}
